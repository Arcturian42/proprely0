...
const urls = [
  ...
  { loc: `${ORIGIN}/auteurs`, priority: '0.6', changefreq: 'monthly', lastmod: CONTENT_LASTMOD, image: DEFAULT_OG_IMAGE, imageTitle: 'Auteurs Proprely' },
  { loc: `${ORIGIN}/glossaire`, priority: '0.7', changefreq: 'monthly', lastmod: CONTENT_LASTMOD, image: DEFAULT_OG_IMAGE, imageTitle: 'Glossaire propreté B2B' },
  { loc: `${ORIGIN}/auteurs/paul-munier`, priority: '0.7', changefreq: 'monthly', lastmod: CONTENT_LASTMOD, image: DEFAULT_OG_IMAGE, imageTitle: 'Paul Munier — Auteur Proprely' },
