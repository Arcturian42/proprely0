...
export const alternatives: AlternativePage[] = [
  {
    ...
    quickTable: [
      ...
      { criterion: "Mobile agent", competitor: "App native (Android/iOS)", proprely: "App Android (Play Store, gratuite, optionnelle) + web · iOS bientôt" },
    ...
    migrationSteps: [
      ...
      { title: "Test en parallèle 1-2 semaines", description: "Gardez Organilog actif en parallèle 1-2 semaines pour vérifier que toutes vos données sont bien remontées dans Proprely. Vos agents peuvent commencer à utiliser Proprely sur mobile (app Android ou lien web)." },
    ...
    faq: [
      ...
      { q: "Mes agents auront-ils besoin de réapprendre un nouvel outil ?", a: "Non. Proprely a une interface 2025-2026 conçue pour la prise en main immédiate. Les agents utilisent l'app Android gratuite (optionnelle) ou un lien web, voient leur planning, scannent le QR du site, prennent les photos avant-après. La courbe d'apprentissage est de l'ordre de la minute, pas de la journée." },
  ...
  },
  {
    ...
    reasonsToLeave: [
      ...
      { title: "App native obligatoire pour les agents", description: "Sur Progiclean, les agents installent souvent une application native obligatoire. Proprely propose une app Android gratuite optionnelle (Play Store), un accès web, et iOS bientôt — sans facturation par agent. Le choix reste à l'équipe." },
    ],
    quickTable: [
      ...
      { criterion: "Mobile agent", competitor: "App native obligatoire", proprely: "App Android (Play Store, gratuite, optionnelle) + web · iOS bientôt" },
  ...
  },
  {
    ...
    tldr: "PROPRET est un éditeur historique du marché français des logiciels propreté (présent depuis les années 1990), avec une base installée importante chez les PME. Proprely est l'alternative nouvelle génération conçue en 2025-2026 : interface aérée, app Android gratuite (optionnelle) + web · iOS bientôt, marge par client en temps réel, onboarding 30 min. Gratuit pendant la bêta privée, tarif fondateur à vie après.",
    reasonsToLeave: [
      ...
      { title: "App mobile native obligatoire pour les agents", description: "PROPRET propose une application mobile native dédiée pour les agents (Android/iOS). Installation, mise à jour, formation, blocages OS… autant de frictions à chaque déploiement. Proprely propose une app Android gratuite (optionnelle) sur le Play Store, un accès web, et iOS bientôt — sans obligation d'installer, sans facturation par agent." },
    ...
    faq: [
      ...
      { q: "Mes agents vont-ils s'adapter à Proprely après l'app PROPRET ?", a: "Oui. Ils peuvent garder le confort d'une app (Android gratuite sur le Play Store) ou ouvrir un lien web — iOS bientôt. Pas d'obligation d'installer, aucun coût par agent. La courbe d'apprentissage reste de quelques minutes." },
  ...
  },
  {
    ...
    tldr: "2BePragma est un éditeur français de logiciels métier propreté, conçu pour les PME structurées (30-100+ agents). Proprely est l'alternative pour les TPE/PME en croissance (3-50 agents) : cockpit unifié déployable en 30 minutes, app Android gratuite (optionnelle) + web · iOS bientôt, devis IA propriétaire, marge par client en temps réel. Gratuit pendant la bêta privée, tarif fondateur à vie après.",
    reasonsToLeave: [
      ...
      { title: "App native obligatoire pour les agents", description: "Sur 2BePragma, les agents installent une application native. Proprely propose une app Android gratuite (optionnelle) + web · iOS bientôt — sans obligation d'installer, sans facturation par agent." },
    ...
    quickTable: [
      ...
      { criterion: "Onboarding", competitor: "Plusieurs jours à semaines", proprely: "30 min avec le fondateur" },
      { criterion: "Mobile agent", competitor: "App native dédiée", proprely: "App Android (Play Store, gratuite, optionnelle) + web · iOS bientôt" },
      { criterion: "Devis IA propriétaire", competitor: "Devis classique", proprely: "Natif (9 facteurs, 3 scénarios)" },
      { criterion: "Marge par client", competitor: "Module reporting/BI", proprely: "Natif sur dashboard" },
      { criterion: "Spécialités agents", competitor: "À paramétrer", proprely: "Natives (vitrerie, moquette, décapage…)" },
    ...
    migrationSteps: [
      ...
      { title: "Test en parallèle 2-4 semaines", description: "Gardez 2BePragma actif en parallèle. Vos agents commencent à utiliser Proprely (app Android ou web). Vous comparez les workflows en condition réelle." },
    ...
    faq: [
      ...
      { q: "Mes équipes vont-elles s'adapter à Proprely après 2BePragma ?", a: "Oui, généralement très vite. Proprely a une interface 2025-2026 conçue pour la prise en main immédiate. Beaucoup de dirigeants nous remontent que leurs équipes (y compris seniors) sont soulagées de passer à une interface aérée. Courbe d'apprentissage : minutes pour les agents (app ou web), heures pour les dirigeants/responsables." },
    ],
