...
export const comparisons: ComparisonPage[] = [
  ...
  },
  {
    ...
    comparisonTable: [
      ...
      { criterion: "Application mobile agent", proprely: "Lien web, pas d'installation", competitor: "App native Android/iOS", edge: 'equal' },
      { criterion: "Mode hors-ligne", proprely: "Oui (sync auto)", competitor: "Oui", edge: 'equal' },
    ...
    faq: [
      ...
      { q: "Synchroteam a-t-il une meilleure app mobile que Proprely ?", a: "Les deux ont leurs avantages. Synchroteam : app native Android/iOS avec notifications push, expérience hors-ligne mature, géolocalisation et optimisation de tournée intégrées. Proprely : lien web mobile-first ouvert dans n'importe quel navigateur, zéro installation, fonctionne sur tous les téléphones (y compris vieux modèles ou partagés). App native = expérience plus riche ; lien web = zéro friction d'adoption agent." },
  ...
  },
  {
    ...
    tldr: "Comète Propreté est un ERP métier français dédié à la propreté, présent sur le marché depuis plusieurs années avec une base installée dans les PME structurées. Proprely est un cockpit nouvelle génération (2025-2026) ciblé TPE/PME 3-50 agents avec onboarding 30 minutes et mobile-first par lien web. Choisissez Comète Propreté si vous êtes une PME établie avec besoin d'ERP large ; choisissez Proprely si vous êtes une TPE/PME en croissance qui veut un cockpit léger.",
    ...
    comparisonTable: [
      ...
      { criterion: "Mobile-first agent", proprely: "Lien web, pas d'installation", competitor: "App native ou web responsive", edge: 'proprely' },
  ...
  },
  {
    ...
    comparisonTable: [
      ...
      { criterion: "Mobile-first agent", proprely: "Lien web, pas d'installation", competitor: "App native ou portail web", edge: 'proprely' },
