...
export const features: FeaturePage[] = [
  {
    ...
    subtitle: "Pour gérer le planning d'une société de nettoyage multi-sites, Proprely propose un planning visuel drag-and-drop avec affectation 1-clic selon la spécialité et la disponibilité. Vos agents consultent leur planning sur mobile : app Android gratuite (optionnelle) ou lien web. iOS bientôt.",
    metaDescription: "Planning agents nettoyage : drag-and-drop, multi-sites, pointage mobile. Bêta 0€ · 0€/agent · app Android optionnelle + web.",
    ...
    benefits: [
      ...
      { icon: Smartphone, title: 'Mobile-first pour vos agents', desc: "Vos agents ouvrent le planning dans l'app Android (Play Store, gratuite) ou via un lien web. Pas d'obligation d'installer. Fonctionne sur 4G capricieuse." },
  ...
  },
  {
    ...
    metaDescription: "Preuve de passage nettoyage : QR, photos, signature, PV auto. Bêta 0€ · 0€/agent · app Android optionnelle. Syndics & médical.",
  ...
  },
  {
    ...
    benefits: [
      ...
      { icon: Smartphone, title: 'Mise à jour mobile par l\'agent', desc: "L'agent ouvre Proprely sur son téléphone (app Android gratuite optionnelle ou navigateur web), voit ses missions du jour, démarre, termine, ajoute photos et notes. iOS bientôt." },
  ...
  },
  {
    ...
    subtitle: "Pointage mobile GPS, calcul automatique des heures travaillées, lutte contre la fraude au temps. Préparez la paie en 2 clics, sans badgeuse. App Android gratuite (optionnelle) ou lien web · iOS bientôt.",
    metaDescription: "Logiciel pointage GPS agents nettoyage : pointage mobile, calcul automatique heures, anti-fraude, export paie Silae. Sans badgeuse · app optionnelle. Bêta gratuite.",
    ...
    benefits: [
      ...
      { icon: Smartphone, title: 'Sans badgeuse · app optionnelle', desc: "Aucun hardware à installer (économie 800-1500 € par site). App Android gratuite sur le Play Store (optionnelle) ou lien web ; iOS bientôt. Aucun coût par agent." },
    ],
    useCases: [
    ...
    faq: [
      ...
      { q: "Les agents doivent-ils télécharger une application ?", a: "Non, ce n'est pas obligatoire. App Android gratuite disponible sur le Play Store ; le lien web reste utilisable. iOS bientôt. Aucun coût par agent." },
      ...
      { q: "Comment se compare le pointage Proprely au pointage Organilog ou PROPRET ?", a: "Organilog propose un pointage mobile générique non spécifique propreté (pas de calcul natif des majorations IDCC 3043). PROPRET et Progiclean ont un pointage métier intégré, mais nécessitent une app native à installer et un setup intégrateur. Proprely est conçu propreté + app Android optionnelle / web + export paie direct, idéal pour TPE/PME B2B 3-50 agents." },
  ...
  },
  {
    ...
    metaDescription: "Facturation société nettoyage : récurrente, e-facture, relances, export. Bêta 0€ · pas de factu/user. Gagnez 4–6 h/mois.",
...
const FEATURE_HOWTO: Record<string, FeatureHowTo> = {
  'planning-nettoyage': {
    ...
    steps: [
      ...
      { name: "Envoyer le planning aux agents", text: "À la validation, chaque agent ouvre son planning sur mobile (app Android gratuite optionnelle ou lien web ; iOS bientôt). Il voit son planning de la semaine et coche les missions terminées en temps réel." },
