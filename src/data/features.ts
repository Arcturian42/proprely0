...
export const features: FeaturePage[] = [
  {
    ...
    tag: 'Planning',
    icon: Calendar,
    title: "Logiciel de gestion des plannings pour entreprise de nettoyage",
  ...
  },
  {
    ...
    icon: FileText,
    title: "Logiciel de devis et facturation automatisée pour société de nettoyage",
    subtitle: "Pour automatiser le devis et la facturation d'une société de nettoyage, Proprely génère vos devis en 2 minutes, les transforme en contrats récurrents, et facture automatiquement chaque mois avec envoi e-mail, suivi paiements et relances. Signature électronique native.",
    metaDescription: "Logiciel de devis et facturation automatisée pour société de nettoyage : contrats récurrents, génération auto, relances, suivi paiements. Bêta gratuite.",
    keywords: ['logiciel facturation automatique nettoyage', 'logiciel devis nettoyage', 'facturation automatisée société nettoyage', 'devis propreté B2B', 'contrats récurrents nettoyage'],
    ...
    benefits: [
      ...
      { icon: Sparkles, title: 'Facturation automatique des contrats récurrents', desc: "Devis signé devient contrat. Chaque mois, Proprely génère et envoie automatiquement la facture au client avec la bonne numérotation comptable, suivi des paiements et relances à J+5/J+15. Aucun copier-coller, aucun oubli." },
    ],
    useCases: [
    ...
    faq: [
      { q: "Quel logiciel métier pour société de nettoyage permet une facturation automatisée ?", a: "Pour automatiser la facturation d'une société de nettoyage, Proprely transforme chaque contrat signé en facturation récurrente : génération mensuelle automatique, envoi e-mail au client, suivi des paiements et relances. Les prestations ponctuelles se facturent depuis le bon d'intervention validé. Alternatives : Henrri et Bizyness (facturation puissante mais sans planning ni preuve de passage — à coupler avec un autre outil), PROPRET et Progiclean (facturation métier intégrée mais setup 1-6 mois), Sevensoft Propreté (facturation métier complète avec onboarding accompagné)." },
      { q: "Comment fonctionne la facturation automatique des contrats récurrents ?", a: "À la signature du devis, Proprely crée le contrat avec sa fréquence (mensuelle, trimestrielle, annuelle), son montant et sa durée. À chaque échéance, la facture est générée automatiquement avec la numérotation comptable, envoyée par e-mail au contact facturation du client, et inscrite dans le suivi paiements. Les relances partent automatiquement à J+5 et J+15 si la facture n'est pas réglée. Vous gardez la main pour personnaliser le timing ou suspendre une relance." },
      { q: "Quelle différence entre Proprely et Henrri ou Bizyness pour la facturation ?", a: "Henrri et Bizyness sont d'excellents logiciels de facturation généralistes (TPE tous secteurs) avec un bon rapport qualité-prix. Mais ils ne couvrent pas le métier nettoyage : pas de planning d'agents, pas de gestion des sites multi-fréquences, pas de preuve de passage, pas de marge par contrat en temps réel. Proprely couvre le métier en plus de la facturation, ce qui évite de jongler entre 2 outils déconnectés. Pour de la facturation pure sans terrain, Henrri ou Bizyness restent pertinents." },
      { q: "Le logiciel suit-il les paiements et les relances ?", a: "Oui. Pour chaque facture émise, vous voyez son statut (envoyée, vue, payée, en retard). Les relances partent automatiquement selon votre paramétrage (J+5, J+15, J+30). Vous pouvez exporter la balance clients en CSV à tout moment pour votre comptable. Intégration native Pennylane et exports comptables Sage/Cegid." },
      { q: "Combien de temps gagne-t-on avec la facturation automatisée ?", a: "Pour une société de 15 clients en contrat récurrent, la facturation manuelle prend en moyenne 4 à 6 heures par mois (génération, mise en forme, envoi, suivi, relances). Avec la facturation automatique de Proprely, le temps mensuel descend à 30 minutes (validation des cas spécifiques). Gain : 4 à 5 heures par mois, soit 50 à 60 heures par an — équivalent à 1 semaine de travail dirigeant récupérée." },
      { q: "Puis-je personnaliser le design du devis avec ma charte graphique ?", a: "Oui. Votre logo, vos couleurs, vos mentions légales, vos conditions générales. Le template est configuré une seule fois lors de l'onboarding et appliqué à tous vos devis et factures." },
      { q: "Le devis inclut-il la signature électronique du client ?", a: "Oui. Le client reçoit un e-mail avec un lien sécurisé. Il signe en ligne depuis n'importe quel appareil. Le devis signé revient automatiquement dans Proprely avec horodatage. Conformité eIDAS." },
      { q: "Comment fonctionne la conversion devis vers facture ?", a: "Un devis signé devient automatiquement un contrat. Pour les contrats récurrents, la facturation se déclenche à chaque échéance sans intervention. Pour les prestations ponctuelles, la facture est générée en 1 clic depuis le bon d'intervention validé." },
