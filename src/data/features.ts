...
export const features: FeaturePage[] = [
  {
    ...
    tag: 'Planning',
    icon: Calendar,
    title: "Logiciel planning nettoyage : agents et sites centralisés",
    ...
    metaDescription: "Logiciel de planning nettoyage B2B : affectation 1-clic, vue agent et site, alertes surmenage, remplacements traçables. Bêta gratuite.",
  ...
  },
  {
    ...
    tag: 'Devis',
    icon: FileText,
    title: "Logiciel de devis nettoyage : devis pro en 2 minutes",
    ...
    metaDescription: "Logiciel de devis nettoyage B2B : génération en 2 minutes, template personnalisé, signature électronique, suivi commercial. Bêta gratuite.",
