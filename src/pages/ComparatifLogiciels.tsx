...
const rows: Row[] = [
  ...
  {
    criteria: 'Application mobile agents (app Android + web · iOS bientôt)',
    proprely: { v: 'App Android + web · 0 €/agent', s: 'ok' },
...
const faq = [
  ...
  { q: "PROPRET ou Proprely : que choisir ?", a: "PROPRET est l'acteur historique (10+ ans), couverture fonctionnelle large, UX plus dense, mobile via app native, intégration souvent par consultant. Proprely est un SaaS de nouvelle génération (2026) : app Android optionnelle + web · iOS bientôt · 0 €/agent, marge par client en surface, onboarding 30 min avec le fondateur. PROPRET est plus adapté aux 50+ agents avec besoins comptables avancés ; Proprely cible 3-50 agents avec besoin de productivité quotidienne." },
  { q: "Progiclean ou Proprely : que choisir ?", a: "Progiclean est un acteur métier solide pour 10-100 agents avec spécialisation propreté forte. Le compromis principal : UX datée et app native obligatoire pour les agents. Proprely propose la même couverture sur les 4 modules essentiels (planning, devis, agents, preuve de passage) avec une UX 2026 et une app Android optionnelle + web (0 €/agent). Pour 3-50 agents en croissance, Proprely est plus agile ; Progiclean reste pertinent au-delà de 50 agents." },
