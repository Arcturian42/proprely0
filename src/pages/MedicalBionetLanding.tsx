...
const faq = [
  ...
  { q: "Mes agents bionettoyage doivent-ils utiliser une application ?", a: "Non, ce n'est pas obligatoire. Ils peuvent utiliser l'app Android gratuite (Play Store) — iOS bientôt — ou ouvrir leur lien dans le navigateur. L'app est un plus, pas une contrainte. Et vous ne payez pas par agent. Fonctionne aussi en 4G dégradée — important dans les sous-sols de cliniques ou locaux techniques." },
