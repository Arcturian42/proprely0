              ...
              {feature && (
                <>
                  ...
                  <button
                    ...
                    className="group block w-full text-left bg-white rounded-2xl border border-slate-100 p-5 sm:p-6 mb-10 hover:border-blue-200 hover:shadow-[0_8px_32px_rgba(0,0,0,0.06)] hover:-translate-y-0.5 active:scale-[0.99] transition-[border-color,box-shadow,transform] duration-200 ease-[var(--ease-out)]"
                  >
                  ...
                  <div className="grid sm:grid-cols-3 gap-4">
                    {otherResources.map((o) => {
                      ...
                      return (
                        <button
                          key={o.slug}
                          onClick={() => navigate(`/ressources/${o.slug}`)}
