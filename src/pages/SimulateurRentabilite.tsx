                ...
                <div className="bg-slate-900 rounded-2xl p-5 sm:p-6 text-white relative overflow-hidden">
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="group bg-white text-slate-900 rounded-xl px-5 py-3 font-bold text-sm hover:bg-slate-100 transition-[background-color,box-shadow,transform] duration-200 ease-[var(--ease-out)] inline-flex items-center gap-2 active:scale-[0.97]"
                    >
