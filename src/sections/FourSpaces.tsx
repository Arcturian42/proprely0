        ...
        >
          <p className="text-base sm:text-lg text-slate-700 max-w-xl leading-relaxed">
            <strong className="text-slate-900 font-bold tabular-nums">
              <AnimatedCounter to={12} duration={1.0} suffix=" transformations" />
